...
.app-button.button--primary { color: var(--hub-accent-text); border-color: var(--hub-accent-line); background: linear-gradient(180deg, color-mix(in srgb, var(--hub-accent) 24%, transparent), color-mix(in srgb, var(--hub-accent) 14%, transparent)); box-shadow: var(--hub-panel-highlight), 0 10px 28px rgb(77 50 142 / 12%); }
